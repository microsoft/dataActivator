...
The following image shows an example of how to trigger an action from a visual that displays today’s sales for each store in a retail chain:
 ![image]([https://github.com/microsoft/dataActivator/images/pbi_context_menu.png](https://github.com/microsoft/dataActivator/blob/main/images/pbi_context_menu.png))
